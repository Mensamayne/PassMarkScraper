...
def scrape_top_components(component_type: str, limit: int = 10, max_attempts: int = None) -> list[dict]:
    """
    ...
    if component_type == "CPU":
        url = "https://www.cpubenchmark.net/cpu_list.php" if use_full_lists else "https://www.cpubenchmark.net/high_end_cpus.html"
    elif component_type == "GPU":
        url = "https://www.videocardbenchmark.net/gpu_list.php" if use_full_lists else "https://www.videocardbenchmark.net/high_end_gpus.html"
    elif component_type == "STORAGE":
        url = "https://www.harddrivebenchmark.net/hdd_list.php" if use_full_lists else "https://www.harddrivebenchmark.net/high_end_drives.html"
    else:
